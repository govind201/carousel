      ...
      <Box sx={{ flexGrow: 1 }}>
        <Grid container spacing={2}>
          <Grid item xs={6}>
            <Item>
            <Fade left  big>
            <Typography variant="h4" style ={{fontWeight: 600}}className={classes.root}>Top Artists</Typography>
            </Fade>
          ...
          <Grid item xs={6}>
            ...
            <Typography variant="h4" style ={{fontWeight: 600}}className={classes.root}>Top Tracks</Typography>
            </Fade>
              {topTracks &&
                topTracks.map((item) => (
                  <List
